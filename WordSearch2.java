...
public class WordSearch2 {
    public static void main(String[] args) {
        ...
        findWords(board,words).stream().forEach(t-> System.out.print(t+" "));
    }
    ...
    public static void dfs(Set<String> list, char[][] board, boolean[][] visited, String str, int x, int y, Trie trie) {
